    ...
    describe('when choices exist', () => {
        ...
        describe('FILTER_CHOICES', () => {
            it('sets active flag based on whether choice is in passed results', () => {
                ...
                const score = 10;
                const active = true;
                const expectedResponse = Object.assign(Object.assign({}, state[0]), { active,
                    score });
        ...
        describe('ACTIVATE_CHOICES', () => {
            it('sets active flag to passed value', () => {
                ...
                const expectedResponse = [
                    Object.assign(Object.assign({}, state[0]), { active: true }),
                    Object.assign(Object.assign({}, state[1]), { active: true }),
                ];
            ...
            describe('when action has a choice id', () => {
                it('disables choice corresponding with id', () => {
                    ...
                    const expectedResponse = [
                        ...
                        Object.assign(Object.assign({}, state[1]), { selected: true }),
                    ];
                    const actualResponse = choices(clonedState, {
                        type: 'ADD_ITEM',
                        choiceId: id,
        ...
        describe('REMOVE_ITEM', () => {
            it('selects choice by passed id', () => {
                ...
                const expectedResponse = [
                    Object.assign({}, state[0]),
                    Object.assign(Object.assign({}, state[1]), { selected: false }),
                ];
                const actualResponse = choices(clonedState, {
                    type: 'REMOVE_ITEM',
                    choiceId: id,
