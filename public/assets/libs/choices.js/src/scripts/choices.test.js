    ...
    describe('constructor', () => {
        describe('config', () => {
          ...
          `;
                    ...
                    expect(instance.config).to.eql(Object.assign(Object.assign({}, DEFAULT_CONFIG), config));
                });
    ...
    describe('public methods', () => {
        ...
        describe('setChoices with callback/Promise', () => {
            ...
            describe('select element', () => {
                it('fetches and sets choices', () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const fetcher = (inst) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('setChoices', () => {
            ...
            const groups = [
                Object.assign(Object.assign({}, choices[0]), { choices }),
                choices[1],
            ];
            beforeEach(() => {
        ...
        describe('_removeItem', () => {
            ...
            describe('when given an item to remove', () => {
                ...
                describe('when the item belongs to a group', () => {
                    ...
                    const itemWithGroup = Object.assign(Object.assign({}, item), { groupId: group.id });
                    beforeEach(() => {
