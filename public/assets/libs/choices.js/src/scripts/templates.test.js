...
describe('templates', () => {
    ...
    describe('choiceGroup', () => {
        ...
        describe('disabled state', () => {
            beforeEach(() => {
                data = Object.assign(Object.assign({}, data), { disabled: true });
            });
            it('returns expected html', () => {
                const expectedOutput = strToEl(`
          <div
    ...
    describe('choice', () => {
        ...
        describe('selected state', () => {
            beforeEach(() => {
                data = Object.assign(Object.assign({}, data), { selected: true });
            });
            it('returns expected html', () => {
                const expectedOutput = strToEl(`
          <div
        ...
        describe('placeholder', () => {
            beforeEach(() => {
                data = Object.assign(Object.assign({}, data), { placeholder: true });
            });
            it('returns expected html', () => {
                const expectedOutput = strToEl(`
          <div
        ...
        describe('child of group', () => {
            beforeEach(() => {
                data = Object.assign(Object.assign({}, data), { groupId: 1 });
            });
            it('returns expected html', () => {
                const expectedOutput = strToEl(`
          <div
    ...
    describe('option', () => {
        ...
        describe('when selected', () => {
            beforeEach(() => {
                data = Object.assign(Object.assign({}, data), { active: true });
            });
