                ...
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav" id="navbar-nav">
                        ...
                        <li className="nav-item">
                            <Link to="/home" className="nav-link menu-link">
                                <i className="las la-tachometer-alt" /> <span data-key="t-dashboards">Principal</span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link menu-link" href="#academicMenu" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="academicMenu">
                                <i className="lab la-delicious" /> <span data-key="t-apps">Academic</span>
                            </a>
                            <div className="collapse menu-dropdown" id="academicMenu">
                                <ul className="nav nav-sm flex-column">
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> New </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> Records </Link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link menu-link" href="#applicationsMenu" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="applicationsMenu">
                                <i className="lab la-delicious" /> <span data-key="t-apps">Applications</span>
                            </a>
                            <div className="collapse menu-dropdown" id="applicationsMenu">
                                <ul className="nav nav-sm flex-column">
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> New </Link>
                                    </li>
                        ...
                        <li className="nav-item">
                            <a className="nav-link menu-link" href="#coursesMenu" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="coursesMenu">
                                <i className="lab la-delicious" /> <span data-key="t-apps">Courses</span>
                            </a>
                            <div className="collapse menu-dropdown" id="coursesMenu">
                                <ul className="nav nav-sm flex-column">
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> New </Link>
                                    </li>
                                    ...
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> Scheduling </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> Grade Publication
                                        </Link>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li className="nav-item">
                            <a className="nav-link menu-link" href="#marketingMenu" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="marketingMenu">
                                <i className="lab la-delicious" /> <span data-key="t-apps">Marketing</span>
                            </a>
                            <div className="collapse menu-dropdown" id="marketingMenu">
                                <ul className="nav nav-sm flex-column">
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> New </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> Campaigns </Link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li className="nav-item">
                            <a className="nav-link menu-link" href="#teachersMenu" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="teachersMenu">
                                <i className="lab la-delicious" /> <span data-key="t-apps">Teachers</span>
                            </a>
                            <div className="collapse menu-dropdown" id="teachersMenu">
                                <ul className="nav nav-sm flex-column">
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link"> New </Link>
                                    </li>
                    ...
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                            <i className="lab la-delicious" /> <span data-key="t-apps">Reports</span>
                        </a>
                        <div className="collapse menu-dropdown" id="sidebarApps">
                            <ul className="nav nav-sm flex-column">
                                ...
                                <li className="nav-item">
                                    <a href="#sidebarAccounts" className="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAccounts" data-key="t-email">
                                        Email
                                    </a>
                                    <div className="collapse menu-dropdown" id="sidebarAccounts">
                                        <ul className="nav nav-sm flex-column">
                                            ...
                                            <li className="nav-item">
                                                <a href="#sidebarAccountsTemplates" className="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAccountsTemplates" data-key="t-email-templates">
                                                    Email Templates
                                                </a>
                                                <div className="collapse menu-dropdown" id="sidebarAccountsTemplates">
                                                    <ul className="nav nav-sm flex-column">
                                                        <li className="nav-item">
                        ...
                        <li className="menu-title"><i className="ri-more-fill" /> <span data-key="t-pages">Administration</span></li>
                        <li className="nav-item">
                            <a className="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i className="lar la-user-circle" /> <span data-key="t-authentication">Users</span>
                            </a>
                            <div className="collapse menu-dropdown" id="sidebarAuth">
                                <ul className="nav nav-sm flex-column">
                                    <li className="nav-item">
                                        <Link to="/users/list" className="nav-link" data-key="t-list">Users </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/UserRole/list" className="nav-link" data-key="t-list">Roles </Link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPages">
                                <i className="las la-pager" /> <span data-key="t-pages">Maintenance</span>
                            </a>
                            <div className="collapse menu-dropdown" id="sidebarPages">
                                <ul className="nav nav-sm flex-column">
                                    <li className="nav-item">
                                        <Link to="/home" className="nav-link" data-key="t-list">Maintenance 1 </Link>
                                    </li>
                                    {/* <li className="nav-item">
                                    ...
                                    <div className="collapse menu-dropdown" id="sidebarProfile">
                                        <ul className="nav nav-sm flex-column">
                                            <li className="nav-item">
                                                <a href="pages-profile.html" className="nav-link" data-key="t-simple-page"> Account Types </a>
                                            </li>
                                            <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <Link to="/home" className="nav-link menu-link">
                                <i className="las la-wrench" /> <span data-key="t-dashboards">Settings</span>
                            </Link>
                        </li>
                    ...
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUI">
                            <i className="las la-pencil-ruler" /> <span data-key="t-base-ui">Base UI</span>
                        </a>
                    ...
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAdvanceUI">
                            <i className="las la-briefcase" /> <span data-key="t-advance-ui">Advance UI</span>
                        </a>
                    ...
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="widgets.html">
                            <i className="las la-flask" /> <span data-key="t-widgets">Widgets</span>
                        </a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarForms">
                            <i className="lar la-newspaper" /> <span data-key="t-forms">Forms</span>
                        </a>
                    ...
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="#sidebarTables" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTables">
                            <i className="las la-table" /> <span data-key="t-tables">Tables</span>
                        </a>
                    ...
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="#sidebarCharts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCharts">
                            <i className="las la-chart-pie" /> <span data-key="t-charts">Charts</span>
                        </a>
                    ...
                    <li className="nav-item">
                        <a className="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarIcons">
                            <i className="lab la-fonticons" /> <span data-key="t-icons">Icons</span>
                        </a>
                        ...
                        <a className="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMaps">
                            <i className="las la-map" /> <span data-key="t-maps">Maps</span>
                        </a>
                        ...
                        <a className="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMultilevel">
                            <i className="las la-folder-plus" /> <span data-key="t-multi-level">Multi Level</span>
                        </a>
