...
export const AccountsPhysicianPage = () => {
                    ...
                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div className="page-title-right">
                            <ol className="breadcrumb m-0">
                                ...
                                <li className="breadcrumb-item active">Physicians</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table className="table align-middle table-nowrap mb-0" id="customerTable">
                                        <thead className="table-light">
                                            <tr>
                                                ...
                                                <th className="sort" scope="col">SSN</th>
                                                <th className="sort" scope="col">Phone</th>
                                                <th className="sort" scope="col">Age</th>
                                        ...
                                        <tbody className="list form-check-all">
                                            ...
                                            {
                                                accounts?.data.filter((account: AccountInterface) => account?.TypeId === 2).map((account: AccountInterface, index: number) => {
                                                    const { Id, Physician, AccountType, CreatedDate } = account
                                                        ...
                                                        <tr key={Id}>
                                                            ...
                                                            <td >
                                                                <div className="d-flex align-items-center">
                                                                    ...
                                                                    <div className="flex-grow-1 ms-2 name"><Link to={`/accounts/details/${Id}`} >{Physician?.FullName}</Link></div>
                                                                </div>
                                                            </td>
                                                            <td >{AccountType?.Name}</td>
                                                            <td >{Physician?.SSN}</td>
                                                            <td >{Physician?.PrimaryPhone}</td>
                                                            <td >{Physician?.Age}</td>
                                                            <td >
